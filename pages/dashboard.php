...
if ($action === 'create' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $allowed_kat = ['Polusi Udara','Sampah Liar','Banjir','Kerusakan Pohon','Lainnya'];
...
$statusList   = ['Pending','Diproses','Selesai'];
$statusColor  = ['Pending'=>'amber','Diproses'=>'blue','Selesai'=>'green'];
?>
<!DOCTYPE html>
<html lang="id">
<head>
